subroutine read_force_field(stat)
   ...
   if (associated(node)) then
      ...
      if (associated(subnode)) then
         ...
         call get_value(subnode, "dihd_k1", bp_paras(BPT%CG)%dihd_k1)
         call get_value(subnode, "dihd_k2", bp_paras(BPT%CG)%dihd_k2)
         call get_value(subnode, "dihd_phi1", bp_paras(BPT%CG)%dihd_phi1)
         call get_value(subnode, "dihd_phi2", bp_paras(BPT%CG)%dihd_phi2)
      endif
      ...
      if (associated(subnode)) then
         ...
         call get_value(subnode, "dihd_k1", bp_paras(BPT%UA)%dihd_k1)
         call get_value(subnode, "dihd_k2", bp_paras(BPT%UA)%dihd_k2)
         call get_value(subnode, "dihd_phi1", bp_paras(BPT%UA)%dihd_phi1)
         call get_value(subnode, "dihd_phi2", bp_paras(BPT%UA)%dihd_phi2)
      endif
      ...
      if (associated(subnode)) then
         ...
         call get_value(subnode, "dihd_k1", bp_paras(BPT%UG)%dihd_k1)
         call get_value(subnode, "dihd_k2", bp_paras(BPT%UG)%dihd_k2)
         call get_value(subnode, "dihd_phi1", bp_paras(BPT%UG)%dihd_phi1)
         call get_value(subnode, "dihd_phi2", bp_paras(BPT%UG)%dihd_phi2)
      endif
